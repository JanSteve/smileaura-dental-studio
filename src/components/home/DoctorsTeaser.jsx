        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {featured.map((doc, i) => (
            <ScrollReveal key={doc.id} delay={i * 0.15}>
              <div className="group bg-navy-card rounded-2xl overflow-hidden border border-white/5 hover:border-gold-primary/30 transition-all duration-500 hover:-translate-y-2">
                <div className="aspect-[3/4] bg-gradient-to-b from-navy-mid to-navy-card overflow-hidden">
                  <div className="w-full h-full flex items-center justify-center group-hover:scale-[1.04] transition-transform duration-500">
                    <div className="text-center">
                      ...
                      <p className="font-mono text-[10px] text-white/20">Portrait Photo</p>
                    </div>
                  </div>
                </div>
                <div className="p-6">
                  <h3 className="font-display text-2xl font-bold text-white mb-1 group-hover:-translate-y-1 transition-transform">{doc.name}</h3>
