...
export default function Footer() {
  return (
    <footer className="bg-navy-deep border-t border-gold-primary/30 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <Link to="/" className="flex items-center gap-3 mb-4">
              ...
              <div><span className="font-display text-xl font-semibold text-white-soft">SmileAura</span><br/><span className="font-mono text-[8px] text-gold-primary tracking-[0.25em]">DENTAL STUDIO</span></div>
            </Link>
            <p className="font-display text-white-muted italic text-lg mb-6">"Where Confidence Begins"</p>
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-navy-mid border border-overlay flex items-center justify-center text-white-muted hover:text-gold-primary hover:border-gold-primary/30 transition-all font-mono text-[10px]">IG</a>
              <a href="#" className="w-10 h-10 rounded-full bg-navy-mid border border-overlay flex items-center justify-center text-white-muted hover:text-gold-primary hover:border-gold-primary/30 transition-all font-mono text-[10px]">FB</a>
              <a href="#" className="w-10 h-10 rounded-full bg-navy-mid border border-overlay flex items-center justify-center text-white-muted hover:text-gold-primary hover:border-gold-primary/30 transition-all font-mono text-[10px]">YT</a>
            </div>
            <p className="font-mono text-[11px] text-grey-text mt-4">Follow Our Journey</p>
          </div>
          {/* Col 2 - Treatments */}
          <div>
            <h4 className="font-heading font-bold text-white-soft mb-6 text-lg">Treatments</h4>
          ...
          {/* Col 3 - Quick Links */}
          <div>
            <h4 className="font-heading font-bold text-white-soft mb-6 text-lg">Quick Links</h4>
          ...
          {/* Col 4 - Contact */}
          <div>
            <h4 className="font-heading font-bold text-white-soft mb-6 text-lg">Contact</h4>
      ...
      {/* Bottom Bar */}
      <div className="border-t border-overlay py-6">
