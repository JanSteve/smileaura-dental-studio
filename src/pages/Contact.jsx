    ...
    <>
            ...
            <ScrollReveal>
              <div className="space-y-6">
                  ...
                  <div key={i} className="flex items-start gap-4">
                    ...
                    <div>
                      {item.isPhone ? <a href="tel:+919876543210" className="font-mono text-xl text-gold-primary hover:text-gold-light block">{item.label}</a>
                        : item.isWa ? <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" className="font-heading font-semibold text-white hover:text-gold-primary">{item.label}</a>
                ...
                <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer"
                  className="block w-full bg-[#25D366] text-white font-heading font-bold text-center py-4 rounded-xl hover:bg-[#20b858] transition-colors mt-6">
              ...
              <div className="glass-card rounded-2xl p-8 border border-gold-border">
                {submitted ? (
                  <div className="text-center py-12">
                    ...
                    <h3 className="font-heading font-bold text-xl text-white mb-2">Appointment Request Sent!</h3>
                    <p className="font-body text-white-muted text-sm">We'll confirm via WhatsApp within 15 minutes.</p>
                  </div>
                ) : (
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    <h3 className="font-heading font-bold text-lg text-white mb-2">Book Your Appointment</h3>
                    {[
                      ...
                      <div key={f.name}>
                        ...
                        <input {...register(f.name)} type={f.type} className="w-full bg-navy-mid border-b-2 border-white/10 focus:border-gold-primary px-4 py-3 rounded-lg text-white font-body outline-none transition-colors" />
                    ...
                    <div>
                      ...
                      <select {...register('doctor')} className="w-full bg-navy-mid border-b-2 border-white/10 focus:border-gold-primary px-4 py-3 rounded-lg text-white font-body outline-none">
                    ...
                    <div>
                      ...
                      <select {...register('treatment')} className="w-full bg-navy-mid border-b-2 border-white/10 focus:border-gold-primary px-4 py-3 rounded-lg text-white font-body outline-none">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <input {...register('date')} type="date" className="w-full bg-navy-mid border-b-2 border-white/10 focus:border-gold-primary px-4 py-3 rounded-lg text-white font-body outline-none" />
                      </div>
                      <div>
                        <label className="font-body text-sm text-white-muted block mb-1">Time Slot</label>
                        <select {...register('timeSlot')} className="w-full bg-navy-mid border-b-2 border-white/10 focus:border-gold-primary px-4 py-3 rounded-lg text-white font-body outline-none">
                      ...
                      <div className="flex gap-3">
                        {['New Patient', 'Existing Patient'].map(t => (
                          <label key={t} className="flex-1">
                            ...
                            <div className="text-center py-2 rounded-lg border border-white/10 peer-checked:border-gold-primary peer-checked:bg-gold-primary/10 transition-all cursor-pointer font-heading text-sm text-white">{t}</div>
                          </label>
                        ))}
                      </div>
                    </div>
                    <div>
                      ...
                      <textarea {...register('notes')} rows={3} className="w-full bg-navy-mid border-b-2 border-white/10 focus:border-gold-primary px-4 py-3 rounded-lg text-white font-body outline-none resize-none" />
                    </div>
              ...
              <div className="space-y-6">
                <div className="rounded-2xl overflow-hidden bg-navy-card aspect-[4/3] border border-white/5 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="font-mono text-sm text-white/30">Map Placeholder</p>
                    <p className="font-mono text-[10px] text-white/20 mt-1">Dark Themed Map</p>
                  </div>
                </div>
                <div className="rounded-2xl border-2 border-gold-primary/40 bg-navy-deep p-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="font-heading font-bold text-white text-lg">Dental Emergency?</h3>
                  </div>
                  ...
                  <a href="https://wa.me/919876543210?text=DENTAL%20EMERGENCY" target="_blank" rel="noopener noreferrer"
                    className="block w-full bg-red-600/80 text-white font-heading font-bold text-center py-3 rounded-xl hover:bg-red-600 transition-colors">Emergency WhatsApp</a>
                </div>
              </div>
            </ScrollReveal>
          </div>
      ...
      <section className="py-20 bg-navy-mid">
        <div className="max-w-[1000px] mx-auto px-6">
          <ScrollReveal className="text-center mb-12"><h2 className="font-heading font-bold text-4xl text-white">Common Questions</h2></ScrollReveal>
          <ScrollReveal>
